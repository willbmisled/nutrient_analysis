...
n_b_um1 | value of first nitrogen blank in a group of observations
n_b_um2 | value of second nitrogen blank in a group of observations
n_mean_b_um | mean of n_b_um1 & n_b_um2 (or value if one is missing); NA means both were missing
p_b_um1 | value of first phosphorus blank in a group of observations
p_b_um2 | value of second phosphorus blank in a group
p_mean_b_um | mean of p_b_um1 & p_b_um2 (or value if one is missing); NA means both were missing
