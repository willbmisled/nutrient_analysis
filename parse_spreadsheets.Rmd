...
p_um_cor | corrected phosphorus concentration (p_um - p_meap_b_um); NOTE if NA this could mean that p_um &/or p_mean_b_um is missing.  Check manually.
p_b_um1 | value of first phosphorus blank in a group of observations; NA indicates value is an outlier or missing.
